  ...
  if (!course) {
    return (
      <div className="text-center py-10">
        ...
        <p className="text-gray-500">The course you're looking for doesn't exist or may have been removed.</p>
      </div>
    );
  }
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          {/* Course Header */}
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">{course.courseTitle}</h1>
            ...
            <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-6">
              ...
              <span className="text-sm">• {course.enrolledStudents?.length || 0} students enrolled</span>
            </div>
          </div>
          ...
          <div className="mb-8 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-800">Course Curriculum</h2>
            </div>
                ...
                {course.chapters.map((chapter, chapterIndex) => (
                  <div key={chapter._id || chapterIndex} className="px-6 py-4">
                    ...
                    {chapter.lectures?.length > 0 ? (
                      ...
                      <p className="text-gray-500 text-sm italic">No lectures added yet</p>
                    )}
                  </div>
                ))}
              </div>
